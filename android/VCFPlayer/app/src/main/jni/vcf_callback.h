...
defines classes for callback to VCF graph and Nodes.
*/

#ifndef __VCF_CALLBACKS_H
#define __VCF_CALLBACKS_H

#include "vcfapi++.h"

// Graph Callback
class MyGraphCallback : public VCFGraph_Callback
{
public:
    MyGraphCallback();
    ~MyGraphCallback();
