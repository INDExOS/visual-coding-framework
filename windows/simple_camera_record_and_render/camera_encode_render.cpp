...
int main(int argc, char* argv[])
{
    ...
    //
    // *Note that this graph assumes that system has a YUY2 camera built-in our attached
    //
    res = myVCFAPI.LoadFile("vcf_camera_endode_render.graphml", &g_pVCFGraph);
    ...
    if(VCFAPI_STATUS_SUCCESS == res)
    {
        ...
        renderTargetInfo.x = 0;
        renderTargetInfo.y = 0;
        renderTargetInfo.w = 600;
        renderTargetInfo.h = 600;
